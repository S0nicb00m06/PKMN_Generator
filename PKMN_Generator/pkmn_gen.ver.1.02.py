...
def main():
    ...
    # Get the name and dex number of the pokemon and store them in the above lists.
    #------------------------------------------------------------
    ...
    #------------------------------------------------------------
    # Randomly select one ability to go with your pokemon
    ...
    print("Type:  ", selection[2])
    print("Abilities:   ", ", ".join(pokedex_abilities[selection_num]))
